...
<div class="pull-left">
<!-- User Image -->
<img src="<%= require('../img/default.png') %>" class="img-circle" alt="User Image">
</div>
...
<img src="<%= require('../img/default.png') %>" class="user-image" alt="User Image">
...
<li>
<a href="javascript:;">
<h4 class="control-sidebar-subheading"><Custom>Template Design</Custom><span class="pull-right-container">
...
<label class="control-sidebar-subheading"><Report>panel usage</Report><input type="checkbox" class="pull-right" checked>
</label>
<p><Some>information about this general settings option</Some></p>
</div>
<!-- /.form-group -->
</form>
</div>
